...
<!-- wp:image {"align":"center","className":"is-style-raft-offset-top"} -->
<figure class="wp-block-image aligncenter is-style-raft-offset-top">
	<img src="' . esc_url( RAFT_URL . 'assets/img/raft-illustration.jpg' ) . '" alt="Header Illustration"/>
</figure>
<!-- /wp:image -->
',
];

			...
			<div class="wp-block-group alignwide">
				...
				<div class="wp-block-columns">
					...
					<div class="wp-block-column">
						<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|50","right":"var:preset|spacing|50"},"blockGap":"var:preset|spacing|30"},"border":{"radius":"5px"}},"layout":{"type":"constrained"}} -->
						<div class="wp-block-group" style="border-radius:5px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
							...
							<p class="has-text-align-center has-small-font-size">' . esc_html( $raft_strings['subtitle'] ) . '</p>
							<!-- /wp:paragraph -->
					...
					<!-- wp:column -->
					<div class="wp-block-column">
						<!-- wp:group {"backgroundColor":"raft-bg","textColor":"raft-fg","layout":{"type":"constrained"}} -->
						<div class="wp-block-group has-raft-fg-color has-raft-bg-background-color has-text-color has-background" style="border-radius:5px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
							<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
							<h3 class="wp-block-heading has-text-align-center has-medium-font-size">' . esc_html( $raft_strings['plan_title'] ) . '</h3>
							<!-- /wp:heading -->
